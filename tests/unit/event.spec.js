...
describe.only('markdown功能测试', () => {
  ...
  it('点击导航栏触发事件', async() => {
    ...
    let verifyClass = wrapper.find('.v-note-navigation-wrapper.transition')
    expect(verifyClass.attributes().style).toContain('display: none;')
    await wrapper.find(buttonClass).trigger('click')
    expect(verifyClass.attributes().style).toBe("")
  })
  // it.only('点击编辑/预览触发事件', async() => {
  //   let buttonedit = '.op-icon.fa.fa-mavon-eye-slash.selected'
  //   let buttonpreview = '.op-icon.fa.fa-mavon-eye'
  //   let edit = wrapper.find('.v-note-edit.divarea-wrapper.scroll-style.scroll-style-border-radius.single-edit.transition')
  //   let editAndPreview = wrapper.find('.v-note-edit.divarea-wrapper.scroll-style.transition')
  //   let preview = wrapper.find('.v-note-edit.divarea-wrapper.scroll-style.single-show.transition')
  //   expect(editAndPreview.exists()).toBe(true)
  //   await wrapper.find(buttonedit).trigger('click')
  //   expect(edit.exists()).toBe(true)
  //   await wrapper.find(buttonpreview).trigger('click')
  //   expect(editAndPreview.exists()).toBe(true)
  // })

  // it('点击全屏编辑触发事件', async() => {
  //   let fullscreen = '.op-icon.fa.fa-mavon-arrows-alt'
  //   let outfullscreen = '.op-icon.fa.fa-mavon-compress.selected'
